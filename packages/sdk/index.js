...
export class CMSClient {
  ...
  async _request(path, method = "GET", body = null) {
    if (!this.baseUrl) {
      throw new Error("baseUrl is required for Global Backend CMS client requests. Ensure NEXT_PUBLIC_CMS_BASE_URL is configured.");
    }
    if (!this.siteId) {
      throw new Error("siteId is required for Global Backend CMS client requests. Ensure NEXT_PUBLIC_SITE_ID is configured.");
    }
...
// Export GlobalBackendClient as an alias of CMSClient for flexibility
export const GlobalBackendClient = CMSClient;

// Re-export scanRoutes utility
export { scanRoutes } from "./sync.js";
