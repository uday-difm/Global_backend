...
export class CMSClient {
  ...
  // --- Dynamic XML Sitemap ---
  getSitemap(domain?: string | null): Promise<any>;

  // --- Next.js Sync Manifest ---
  syncRoutes(routes: RouteSyncPayload[], integrationKey: string, framework?: string): Promise<any>;
}

export const GlobalBackendClient: typeof CMSClient;

export function scanRoutes(appDir: string): RouteSyncPayload[];
export function getAppRouterPath(cwd?: string): { absolute: string; relative: string } | null;
