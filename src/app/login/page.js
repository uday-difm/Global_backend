  ...
  async function handleSubmit(e) {
    ...
    if (recaptchaSiteKey) {
      if (!window.grecaptcha) {
        return setError("reCAPTCHA is still loading. Please wait and try again.");
      }
      try {
        recaptchaToken = widgetIdRef.current !== null
          ? window.grecaptcha.getResponse(widgetIdRef.current)
          : window.grecaptcha.getResponse();
      } catch {
        // Widget was destroyed (e.g. page HMR) — re-render it and ask user to retry
        ...
        return setError("reCAPTCHA was reset. Please complete the verification and try again.");
      }
      if (!recaptchaToken) {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-indigo-500 selection:text-white">
      ...
      <header className="sticky top-0 z-50 bg-slate-950/80 backdrop-blur-md border-b border-slate-900 px-6 lg:px-12 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="font-extrabold text-base tracking-tight block">Global Backend</span>
              <span className="text-[10px] text-indigo-400 font-semibold uppercase tracking-wider block -mt-1">Headless CMS</span>
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-400">
            ...
            <a href="#features" className="hover:text-indigo-400 flex items-center gap-1.5 transition">
      ...
      <main className="grow">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 text-left space-y-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight leading-tight text-white">
                Modern Headless CMS & <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 via-violet-400 to-fuchsia-400">Admin Engine</span>
              </h1>
              ...
              <div className="pt-4 flex flex-wrap gap-2.5">
                {["Next.js App Router", "Prisma ORM", "PostgreSQL", "NextAuth Security", "Cloudinary Media", "TOTP 2FA"].map((tech) => (
                  <span key={tech} className="px-3 py-1.5 rounded-lg bg-slate-900 border border-slate-800 text-xs font-medium text-slate-300">
                    {tech}
                  </span>
                ))}
              </div>
              ...
              <div className="pt-6 grid grid-cols-3 gap-6 max-w-md border-t border-slate-900">
                <div>
                  <span className="block text-2xl font-extrabold text-white">100ms</span>
                  <span className="block text-[11px] font-semibold text-slate-500 uppercase tracking-wider">Avg Latency</span>
                </div>
                <div>
                  <span className="block text-2xl font-extrabold text-white">Scoping</span>
                  <span className="block text-[11px] font-semibold text-slate-500 uppercase tracking-wider">Tenant Scoped</span>
                </div>
                <div>
                  <span className="block text-2xl font-extrabold text-white">2FA</span>
                  <span className="block text-[11px] font-semibold text-slate-500 uppercase tracking-wider">MFA Secured</span>
                </div>
              </div>
            </div>

            {/* Login Widget Container */}
            <div id="login-card-section" className="lg:col-span-5 flex justify-center">
              <div className="w-full max-w-md rounded-2xl bg-slate-900/60 border border-slate-800 p-8 shadow-2xl backdrop-blur-xl hover:border-indigo-500/30 transition duration-300">
                <div className="mb-6 text-center">
                  ...
                  <p className="text-slate-400 text-xs mt-1">Sign in with your CMS admin credentials</p>
                </div>
        ...
        {/* ── FEATURES SECTION ────────────────────────────────────────────── */}
        <section id="features" className="py-20 px-6 lg:px-12 bg-slate-950 border-b border-slate-900">
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl font-extrabold text-white">Full-Stack CMS Features</h2>
              <p className="text-slate-400 text-sm mt-2">Everything required to govern, serve, and secure website portfolios.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="p-6 rounded-2xl bg-slate-900 border border-slate-800 hover:border-slate-700 transition">
                ...
                <h3 className="font-bold text-white text-base mb-2">Multi-Site PostgreSQL Scoping</h3>
                <p className="text-slate-400 text-xs leading-relaxed">
                  Database is strictly partitioned by `siteId`. Integrate multiple clients on different domains while maintaining data isolation.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-slate-900 border border-slate-800 hover:border-slate-700 transition">
                ...
                <h3 className="font-bold text-white text-base mb-2">Security Hardened Entry</h3>
                <p className="text-slate-400 text-xs leading-relaxed">
                  Authentication is protected using Google reCAPTCHA verification, rate-limiting, and TOTP 2FA credentials verification.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-slate-900 border border-slate-800 hover:border-slate-700 transition">
                ...
                <h3 className="font-bold text-white text-base mb-2">Cloudinary Asset Pipeline</h3>
                <p className="text-slate-400 text-xs leading-relaxed">
                  Secure media directories, media compression via Cloudinary CDN, subfolder mappings, and optimized image rendering.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-slate-900 border border-slate-800 hover:border-slate-700 transition">
                ...
                <h3 className="font-bold text-white text-base mb-2">Live Analytics & GDPR</h3>
                <p className="text-slate-400 text-xs leading-relaxed">
                  Monitor active viewer histories, request rates, error logs, and visitor cookie consent tracking directly in the dashboard.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-slate-900 border border-slate-800 hover:border-slate-700 transition">
                ...
                <h3 className="font-bold text-white text-base mb-2">Structured Layout Builder</h3>
                <p className="text-slate-400 text-xs leading-relaxed">
                  Customize layout headers, footers, redirects, legal pages, testimonials, services, and dynamic sections on the fly.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-slate-900 border border-slate-800 hover:border-slate-700 transition">
                ...
                <h3 className="font-bold text-white text-base mb-2">Role-Based (RBAC) Permissions</h3>
                <p className="text-slate-400 text-xs leading-relaxed">
                  Support granular permissions through global roles (Superadmin, Editor, Author, Viewer) and site-specific mapping.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="architecture" className="py-20 px-6 lg:px-12 bg-slate-950/50">
          <div className="max-w-7xl mx-auto">
            <div className="max-w-3xl mb-12">
              <h2 className="text-3xl font-extrabold text-white">System Architecture</h2>
              <p className="text-slate-400 text-sm mt-2">Unified modular flow between site clients, database layer, and Next.js portal.</p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6 text-slate-400 text-sm leading-relaxed">
                <p>
                  The Global Backend CMS serves as a decoupled content gateway. Website frontends map their site identity using an HTTP header (`x-site-id`) or query string, allowing the Next.js API layer to fetch isolated database structures.
                </p>
                <div className="space-y-4 pt-2">
                  <div className="flex gap-4">
                    <span className="w-6 h-6 rounded-full bg-indigo-500/20 text-indigo-400 text-xs font-bold flex items-center justify-center shrink-0">1</span>
                    <div>
                      <h4 className="font-bold text-white text-sm">Prisma Database Transactions</h4>
                      <p className="text-xs text-slate-500 mt-0.5">Transactions ensure atomic changes across pages, sections, categories, and audit histories.</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <span className="w-6 h-6 rounded-full bg-indigo-500/20 text-indigo-400 text-xs font-bold flex items-center justify-center shrink-0">2</span>
                    <div>
                      <h4 className="font-bold text-white text-sm">Dynamic Metadata Rendering</h4>
                      <p className="text-xs text-slate-500 mt-0.5">Automatic OpenGraph schemas, JSON-LD scripts injection, and sitemaps are served from site content rows.</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <span className="w-6 h-6 rounded-full bg-indigo-500/20 text-indigo-400 text-xs font-bold flex items-center justify-center shrink-0">3</span>
                    <div>
                      <h4 className="font-bold text-white text-sm">IP blocking & Rate-limiting</h4>
                      <p className="text-xs text-slate-500 mt-0.5">A built-in custom token bucket check restricts rapid form submissions and blocks blacklisted IPs dynamically.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 rounded-2xl bg-slate-900 border border-slate-800 space-y-4">
                ...
                <div className="space-y-3 pt-2">
                  <div className="p-3 bg-slate-950 rounded-xl border border-slate-850 flex justify-between text-xs">
                    <span className="font-mono text-indigo-400 font-semibold">GET /api/content?siteId=...</span>
                    <span className="text-slate-400">Reads layout, pages, and dynamic lists</span>
                  </div>
                  <div className="p-3 bg-slate-950 rounded-xl border border-slate-850 flex justify-between text-xs">
                    <span className="font-mono text-indigo-400 font-semibold">POST /api/forms/submit</span>
                    <span className="text-slate-400">Verifies reCAPTCHA and captures new leads</span>
                  </div>
                  <div className="p-3 bg-slate-950 rounded-xl border border-slate-850 flex justify-between text-xs">
                    <span className="font-mono text-indigo-400 font-semibold">GET /preview?pageId=...</span>
                    <span className="text-slate-400">Renders live draft layout templates</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-slate-950 border-t border-slate-900 py-8 px-6 text-center text-xs text-slate-650">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <p>© {new Date().getFullYear()} Global Backend Project. Secured with NextAuth & Google reCAPTCHA.</p>
          <p className="flex gap-4">
            <a href="#features" className="hover:text-indigo-400 transition">Documentation</a>
            <span>·</span>
            <a href="/login" className="hover:text-indigo-400 transition">Access Console</a>
          </p>
        </div>
      </footer>
    </div>
