                    ...
                    {item.photo ? (
                      <img
                        ...
                        onError={(e) => {
                          ...
                          e.target.src = "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=100&h=100&q=80"; // fallback
                        }}
                      />
                    ) : (
                ...
                <div className="mt-5 border-t pt-3 flex items-center justify-between">
                  <div className="flex gap-2 text-gray-400">
                    ...
                    {!social.twitter && !social.linkedin && !social.website && (
                      <span className="text-[10px] italic text-gray-400">No social links</span>
                    )}
                  </div>
